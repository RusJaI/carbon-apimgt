...
CREATE SEQUENCE IDN_OAUTH_CONSUMER_APPS_PK_SEQ START 1 INCREMENT 1;
...
DROP SEQUENCE IF EXISTS IDN_OAUTH_CONSUMER_SECRETS_SEQUENCE;
CREATE SEQUENCE IDN_OAUTH_CONSUMER_SECRETS_SEQUENCE START 1 INCREMENT 1;
CREATE TABLE IF NOT EXISTS IDN_OAUTH_CONSUMER_SECRETS (
    ID INTEGER DEFAULT NEXTVAL('IDN_OAUTH_CONSUMER_SECRETS_SEQUENCE'),
...
CREATE SEQUENCE IDN_OAUTH2_ACCESS_TOKEN_AUDIT_PK_SEQ START 1 INCREMENT 1;
CREATE TABLE IF NOT EXISTS IDN_OAUTH2_ACCESS_TOKEN_AUDIT (
            IDN_OAUTH2_ACCESS_TOKEN_AUDIT_ID INTEGER DEFAULT NEXTVAL('IDN_OAUTH2_ACCESS_TOKEN_AUDIT_PK_SEQ'),
            TOKEN_ID VARCHAR (255),
            ACCESS_TOKEN VARCHAR(2048),
            REFRESH_TOKEN VARCHAR(2048),
            CONSUMER_KEY_ID INTEGER,
...
DROP SEQUENCE IF EXISTS IDN_OAUTH2_DEVICE_FLOW_SCOPES_PK_SEQ;
CREATE SEQUENCE IDN_OAUTH2_DEVICE_FLOW_SCOPES_PK_SEQ START 1 INCREMENT 1;
CREATE TABLE IF NOT EXISTS IDN_OAUTH2_DEVICE_FLOW_SCOPES (
            ID INTEGER PRIMARY KEY DEFAULT NEXTVAL('IDN_OAUTH2_DEVICE_FLOW_SCOPES_PK_SEQ'),
...
CREATE SEQUENCE IDN_OAUTH2_SCOPE_PK_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDN_OAUTH2_SCOPE_BINDING_PK_SEQ START 1 INCREMENT 1;
CREATE TABLE IF NOT EXISTS IDN_OAUTH2_SCOPE_BINDING (
            IDN_OAUTH2_SCOPE_BINDING_ID INTEGER DEFAULT NEXTVAL('IDN_OAUTH2_SCOPE_BINDING_PK_SEQ'),
...
CREATE SEQUENCE IDN_SCIM_GROUP_PK_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDN_STS_STORE_PK_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDN_AUTH_USER_SESSION_MAPPING_PK_SEQ START 1 INCREMENT 1;
CREATE TABLE IDN_AUTH_USER_SESSION_MAPPING (
    IDN_AUTH_USER_SESSION_MAPPING_ID INTEGER DEFAULT NEXTVAL('IDN_AUTH_USER_SESSION_MAPPING_PK_SEQ'),
	USER_ID VARCHAR(255) NOT NULL,
	SESSION_ID VARCHAR(255) NOT NULL,
...
CREATE SEQUENCE SP_APP_SEQ START 1 INCREMENT 1;
CREATE TABLE SP_APP (
...
CREATE SEQUENCE SP_METADATA_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE SP_INBOUND_AUTH_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE SP_AUTH_STEP_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE SP_CLAIM_DIALECT_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE SP_CLAIM_MAPPING_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE SP_ROLE_MAPPING_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE SP_REQ_PATH_AUTH_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE SP_PROV_CONNECTOR_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE SP_AUTH_SCRIPT_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE SP_TEMPLATE_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDN_AUTH_WAIT_STATUS_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDP_SEQ START 1 INCREMENT 1;
CREATE TABLE IDP (
...
CREATE SEQUENCE IDP_ROLE_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDP_ROLE_MAPPING_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDP_CLAIM_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDP_CLAIM_MAPPING_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDP_AUTHENTICATOR_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDP_METADATA_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDP_AUTHENTICATOR_PROP_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDP_PROV_CONFIG_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDP_PROV_CONFIG_PROP_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDP_PROV_ENTITY_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDP_LOCAL_CLAIM_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDN_ASSOCIATED_ID_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE WF_WORKFLOW_ASSOCIATION_PK_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDN_PASSWORD_HISTORY_DATA_PK_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDN_CLAIM_DIALECT_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDN_CLAIM_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDN_CLAIM_MAPPED_ATTRIBUTE_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDN_CLAIM_PROPERTY_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDN_CLAIM_MAPPING_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDN_SAML2_ASSERTION_STORE_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDN_SAML2_ARTIFACT_STORE_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDN_OIDC_PROPERTY_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDN_OIDC_REQUEST_OBJECT_REF_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDN_OIDC_REQ_OBJECT_CLAIMS_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDN_OIDC_REQ_OBJECT_CLAIM_VALUES_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDN_CERTIFICATE_PK_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDN_OIDC_SCOPE_CLAIM_MAPPING_PK_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDN_OAUTH2_CIBA_REQUEST_SCOPES_PK_SEQ START 1 INCREMENT 1;
CREATE TABLE IF NOT EXISTS IDN_OAUTH2_CIBA_REQUEST_SCOPES (
    IDN_OAUTH2_CIBA_REQUEST_SCOPES_ID INTEGER DEFAULT NEXTVAL('IDN_OAUTH2_CIBA_REQUEST_SCOPES_PK_SEQ'),
    AUTH_CODE_KEY CHAR (36),
    SCOPE VARCHAR (255),
...
CREATE SEQUENCE IDN_FED_AUTH_SESSION_MAPPING_PK_SEQ START 1 INCREMENT 1;
CREATE TABLE IDN_FED_AUTH_SESSION_MAPPING (
    ID INTEGER PRIMARY KEY DEFAULT NEXTVAL('IDN_FED_AUTH_SESSION_MAPPING_PK_SEQ'),
...
CREATE SEQUENCE IDN_CORS_ORIGIN_PK_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDN_OAUTH2_USER_CONSENT_PK_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDN_OAUTH2_USER_CONSENTED_SCOPES_PK_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE SP_SHARED_APP_PK_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDN_UMA_RESOURCE_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDN_UMA_RESOURCE_META_DATA_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDN_UMA_RESOURCE_SCOPE_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDN_UMA_PERMISSION_TICKET_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDN_UMA_PT_RESOURCE_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE IDN_UMA_PT_RESOURCE_SCOPE_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE CM_PII_CATEGORY_PK_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE CM_PURPOSE_PK_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE CM_PURPOSE_CATEGORY_PK_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE CM_RECEIPT_SP_ASSOC_PK_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE CM_SP_PURPOSE_ASSOC_PK_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE CM_SP_PURPOSE_PURPOSE_CAT_ASSC_PK_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE CM_PURPOSE_PII_CAT_ASSOC_PK_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE CM_SP_PURPOSE_PII_CAT_ASSOC_PK_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE CM_CONSENT_RECEIPT_PROPERTY_PK_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE AM_SUBSCRIBER_SEQUENCE START 1 INCREMENT 1;
...
CREATE SEQUENCE AM_APPLICATION_SEQUENCE START 1 INCREMENT 1;
...
CREATE SEQUENCE AM_API_SEQUENCE START 1 INCREMENT 1;
...
DROP TABLE IF EXISTS AM_API_METADATA;
...
CREATE SEQUENCE AM_API_URL_MAPPING_SEQUENCE START 1 INCREMENT 1;
CREATE TABLE IF NOT EXISTS AM_API_URL_MAPPING (
    ...
    DESCRIPTION BYTEA,
    SCHEMA_DEFINITION BYTEA,
    REVISION_UUID VARCHAR(255),
    LOG_LEVEL VARCHAR(255) DEFAULT 'OFF',
    PRIMARY KEY(URL_MAPPING_ID)
);

CREATE SEQUENCE AM_BACKEND_OPERATION_MAPPING_SEQUENCE START 1 INCREMENT 1;
CREATE TABLE IF NOT EXISTS AM_BACKEND_OPERATION_MAPPING (
    MAPPING_ID       INTEGER DEFAULT nextval('am_backend_operation_mapping_sequence'),
...
CREATE SEQUENCE AM_API_OPERATION_MAPPING_SEQUENCE START 1 INCREMENT 1;
CREATE TABLE IF NOT EXISTS AM_API_OPERATION_MAPPING (
    MAPPING_ID          INTEGER DEFAULT nextval('am_api_operation_mapping_sequence'),
    URL_MAPPING_ID      INTEGER NOT NULL,
...
CREATE SEQUENCE AM_API_PRODUCT_MAPPING_SEQUENCE START 1 INCREMENT 1;
...
CREATE SEQUENCE AM_SUBSCRIPTION_SEQUENCE START 1 INCREMENT 1;
...
CREATE SEQUENCE AM_APPLICATION_REGISTRATION_SEQUENCE START 1 INCREMENT 1;
...
CREATE SEQUENCE AM_API_LC_EVENT_SEQUENCE START 1 INCREMENT 1;
...
CREATE SEQUENCE AM_WORKFLOWS_SEQUENCE START 1 INCREMENT 1;
...
CREATE SEQUENCE AM_API_RATINGS_SEQUENCE START 1 INCREMENT 1;
...
CREATE SEQUENCE AM_TIER_PERMISSIONS_SEQUENCE START 1 INCREMENT 1;
...
CREATE SEQUENCE AM_EXTERNAL_STORES_SEQUENCE START 1 INCREMENT 1;
...
CREATE SEQUENCE AM_API_DEFAULT_VERSION_PK_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE AM_ALERT_TYPES_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE AM_ALERT_EMAILLIST_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE AM_POLICY_SUBSCRIPTION_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE AM_POLICY_APPLICATION_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE AM_POLICY_HARD_THROTTLING_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE AM_API_THROTTLE_POLICY_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE AM_CONDITION_GROUP_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE AM_QUERY_PARAMETER_CONDITION_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE AM_HEADER_FIELD_CONDITION_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE AM_JWT_CLAIM_CONDITION_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE AM_IP_CONDITION_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE AM_POLICY_GLOBAL_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE AM_THROTTLE_TIER_PERMISSIONS_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE AM_BLOCK_CONDITIONS_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE AM_API_LC_PUBLISH_EVENTS_PK_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE AM_API_SYSTEM_APPS_SEQUENCE START 1 INCREMENT 1;
...
DROP TABLE IF EXISTS AM_GW_PLATFORM_API_ARTIFACTS;
...
CREATE SEQUENCE AM_SCOPE_PK_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE AM_GATEWAY_ENVIRONMENT_PK_SEQ START 1 INCREMENT 1;
...
CREATE SEQUENCE AM_GW_INSTANCES_PK_SEQ START WITH 1 INCREMENT BY 1;
CREATE TABLE IF NOT EXISTS AM_GW_INSTANCES (
    GATEWAY_ID INTEGER DEFAULT NEXTVAL('AM_GW_INSTANCES_PK_SEQ') NOT NULL,
    GATEWAY_UUID VARCHAR(255) NOT NULL,
    ORGANIZATION VARCHAR(128) NOT NULL,
    LAST_UPDATED TIMESTAMP NOT NULL,
    GW_PROPERTIES BYTEA NOT NULL,
...
CREATE SEQUENCE AM_WEBHOOKS_PK_SEQ START 1 INCREMENT 1;
...
DROP SEQUENCE IF EXISTS AM_WEBHOOKS_UNSUBSCRIPTION_PK_SEQ;
CREATE SEQUENCE AM_WEBHOOKS_UNSUBSCRIPTION_PK_SEQ START 1 INCREMENT 1;
CREATE TABLE IF NOT EXISTS AM_WEBHOOKS_UNSUBSCRIPTION (
          AM_WEBHOOKS_UNSUBSCRIPTION_ID INTEGER DEFAULT NEXTVAL('AM_WEBHOOKS_UNSUBSCRIPTION_PK_SEQ'),
          API_UUID VARCHAR(255) NOT NULL,
          APPLICATION_ID VARCHAR(20) NOT NULL,
          TENANT_DOMAIN VARCHAR(255) NOT NULL,
          HUB_CALLBACK_URL VARCHAR(1024) NOT NULL,
...
DROP SEQUENCE IF EXISTS AM_OPERATION_POLICY_DEFINITION_SEQUENCE;
CREATE SEQUENCE AM_OPERATION_POLICY_DEFINITION_SEQUENCE START 1 INCREMENT 1;
DROP TABLE IF EXISTS AM_OPERATION_POLICY_DEFINITION;
CREATE TABLE IF NOT EXISTS AM_OPERATION_POLICY_DEFINITION (
   DEFINITION_ID INTEGER DEFAULT NEXTVAL('AM_OPERATION_POLICY_DEFINITION_SEQUENCE'),
   POLICY_UUID VARCHAR(45) NOT NULL,
...
DROP SEQUENCE IF EXISTS AM_OPERATION_POLICY_CLONED_SEQUENCE;
CREATE SEQUENCE AM_OPERATION_POLICY_CLONED_SEQUENCE START 1 INCREMENT 1;
DROP TABLE IF EXISTS AM_COMMON_OPERATION_POLICY;
CREATE TABLE IF NOT EXISTS AM_COMMON_OPERATION_POLICY (
   COMMON_POLICY_ID INTEGER DEFAULT NEXTVAL('AM_OPERATION_POLICY_CLONED_SEQUENCE'),
   POLICY_UUID VARCHAR(45) NOT NULL,
   FOREIGN KEY (POLICY_UUID) REFERENCES AM_OPERATION_POLICY(POLICY_UUID) ON DELETE CASCADE,
   PRIMARY KEY(COMMON_POLICY_ID)
);

DROP SEQUENCE IF EXISTS AM_API_OPERATION_POLICY_SEQUENCE;
CREATE SEQUENCE AM_API_OPERATION_POLICY_SEQUENCE START 1 INCREMENT 1;
DROP TABLE IF EXISTS AM_API_OPERATION_POLICY;
CREATE TABLE IF NOT EXISTS AM_API_OPERATION_POLICY (
   API_SPECIFIC_POLICY_ID INTEGER DEFAULT NEXTVAL('AM_API_OPERATION_POLICY_SEQUENCE'),
   POLICY_UUID VARCHAR(45) NOT NULL,
...
DROP SEQUENCE IF EXISTS AM_API_OPERATION_POLICY_MAPPING_SEQUENCE;
CREATE SEQUENCE AM_API_OPERATION_POLICY_MAPPING_SEQUENCE START 1 INCREMENT 1;
DROP TABLE IF EXISTS AM_API_OPERATION_POLICY_MAPPING;
CREATE TABLE IF NOT EXISTS AM_API_OPERATION_POLICY_MAPPING (
   OPERATION_POLICY_MAPPING_ID INTEGER DEFAULT NEXTVAL('AM_API_OPERATION_POLICY_MAPPING_SEQUENCE'),
   URL_MAPPING_ID INTEGER NOT NULL,
   POLICY_UUID VARCHAR(45) NOT NULL,
...
DROP SEQUENCE IF EXISTS AM_API_POLICY_MAPPING_SEQUENCE;
CREATE SEQUENCE AM_API_POLICY_MAPPING_SEQUENCE START 1 INCREMENT 1;
DROP TABLE IF EXISTS AM_API_POLICY_MAPPING;
CREATE TABLE IF NOT EXISTS AM_API_POLICY_MAPPING (
   API_POLICY_MAPPING_ID INTEGER DEFAULT NEXTVAL('AM_API_POLICY_MAPPING_SEQUENCE'),
   API_UUID VARCHAR(256) NOT NULL,
   REVISION_UUID VARCHAR(45),
   POLICY_UUID VARCHAR(45) NOT NULL,
   POLICY_ORDER INTEGER NOT NULL,
...
DROP SEQUENCE IF EXISTS AM_GATEWAY_POLICY_MAPPING_SEQUENCE;
CREATE SEQUENCE AM_GATEWAY_POLICY_MAPPING_SEQUENCE START 1 INCREMENT 1;
DROP TABLE IF EXISTS AM_GATEWAY_POLICY_MAPPING;
CREATE TABLE IF NOT EXISTS AM_GATEWAY_POLICY_MAPPING (
    POLICY_TO_FLOW_INFO_MAPPING_ID INTEGER DEFAULT NEXTVAL('AM_GATEWAY_POLICY_MAPPING_SEQUENCE'),
    GLOBAL_POLICY_MAPPING_UUID     VARCHAR(45)   NOT NULL,
    POLICY_UUID                    VARCHAR(45)   NOT NULL,
    POLICY_ORDER                   INTEGER       NOT NULL,
    DIRECTION                      VARCHAR(10)   NOT NULL,
...
DROP TABLE IF EXISTS AM_TASK_LOCK;
...
CREATE TABLE IF NOT EXISTS AM_API_KEY (
            ...
            KEY_TYPE VARCHAR(100),
            API_KEY_PROPERTIES BYTEA DEFAULT NULL,
            AUTHZ_USER VARCHAR(512),
            TIME_CREATED TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
            VALIDITY_PERIOD BIGINT,
...
DROP TABLE IF EXISTS AM_API_KEY_API_MAPPING;
...
DROP TABLE IF EXISTS AM_API_KEY_APPLICATION_MAPPING;

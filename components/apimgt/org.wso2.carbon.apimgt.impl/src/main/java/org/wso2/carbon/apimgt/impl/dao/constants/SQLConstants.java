...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String GET_API_KEY_DETAILS_FROM_KEY_UUID_WITHOUT_TENANT_SQL =
            "SELECT K.API_KEY_UUID, K.NAME, K.API_KEY_HASH, K.KEY_TYPE, K.API_KEY_PROPERTIES, K.AUTHZ_USER, K.VALIDITY_PERIOD, K.LAST_USED, "
                    + "(SELECT MIN(KM.API_UUID) FROM AM_API_KEY_API_MAPPING KM WHERE KM.API_KEY_UUID = K.API_KEY_UUID) AS API_UUID, "
                    + "(SELECT MIN(AM.APPLICATION_UUID) FROM AM_API_KEY_APPLICATION_MAPPING AM WHERE AM.API_KEY_UUID = K.API_KEY_UUID) AS APPLICATION_UUID "
